...
contract ACL is IACL, AragonApp, ACLHelpers {
    ...
    */
        ...
        returns (bool)
    {
        if (Op(_param.op) == Op.IF_ELSE) {
            ...
            bool result = evalParam(_paramsHash, conditionParam, _who, _where, _what, _how);

            return evalParam(_paramsHash, result ? successParam : failureParam, _who, _where, _what, _how);
        }
        ...
        bool r1 = evalParam(_paramsHash, param1, _who, _where, _what, _how);
        ...
        bool r2 = evalParam(_paramsHash, param2, _who, _where, _what, _how);
    ...
    */
    ...
    function roleHash(address _where, bytes32 _what) internal pure returns (bytes32) {
        return keccak256(abi.encodePacked(uint256(1), _where, _what));
    }

    function permissionHash(address _who, address _where, bytes32 _what) internal pure returns (bytes32) {
        return keccak256(abi.encodePacked(uint256(2), _who, _where, _what));
    }
